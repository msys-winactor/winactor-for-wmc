...
1. 「ライセンス一覧」タブを開きます
2. 受領したライセンスファイル（`.json`）をドラッグ＆ドロップまたはファイル選択で取り込みます
3. 確認画面が表示されるので、ライセンス情報（製品名・種別・有効期限）を確認し、登録を確定します
4. ライセンス一覧にライセンスが追加されたことを確認します

## 認証手順（トライアル）

1. 「ライセンス一覧」タブを開きます
2. 弊社から受領したトライアル用ライセンスファイル（`.json`）をドラッグ＆ドロップまたはファイル選択で取り込みます
3. 確認画面が表示されるので、内容を確認し、登録を確定します
4. ライセンス一覧にライセンスが追加されたことを確認します
