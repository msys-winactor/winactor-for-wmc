...
5. 生成された製品 ID をファイルに保存します

フォームに入力した内容は自動的に保存され、次回起動時に復元されます。

### Step 2：製品 ID の送付

1. 保存した製品 ID ファイルを弊社担当者へメールで送付します
2. 弊社にてライセンスファイル（`.lic`）を発行し、返送いたします

### Step 3：ライセンスの登録

1. 「ライセンス一覧」タブを開きます
2. 受領したライセンスファイル（`.lic`）をドラッグ＆ドロップまたはファイル選択で登録します
3. 署名検証・有効期限・端末照合が自動的に行われ、一覧に追加されます

## 認証手順（トライアル）

1. 「ライセンス一覧」タブを開きます
2. 弊社から受領したトライアル用ライセンスファイル（`.lic`）をドラッグ＆ドロップまたはファイル選択で登録します
