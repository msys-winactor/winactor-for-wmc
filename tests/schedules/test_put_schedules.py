...
def test_run_all_departments(mocker):
    mock_get_departments = mocker.patch(
        "winactor_for_wmc.schedules.put_schedules.get_departments"
    )
    mock_client_class = mocker.patch(
        "winactor_for_wmc.schedules.put_schedules.WMCApiClient"
    )
    ...
    mock_client.put.assert_called_once_with(
        f"/schedules/{schedule_id}", data=schedule_dict
    )
